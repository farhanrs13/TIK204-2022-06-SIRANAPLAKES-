 ...
 <div align="center">
  ...
  <?php
   if (isset($_POST['generate'])) {
       ...
       echo '<img src="barcode.php?text=' . $_POST['kodeBarcode'] . '&print=true&size=65" />';
       ...
       $fileImage = $protocol . $_SERVER['HTTP_HOST'] . dirname($_SERVER['PHP_SELF']) . "barcode.php?text=" . $_POST['kodeBarcode'] . "&print=true&size=65";
